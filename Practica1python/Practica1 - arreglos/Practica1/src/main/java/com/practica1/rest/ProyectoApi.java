...
public class ProyectoApi {
    ...
    public Response save(HashMap<String, Object> map) {
        ...
        // Asignar Inversionista y Propuesta desde el HashMap
        HashMap<String, Object> inversionistaMap = (HashMap<String, Object>) map.get("inversionista");
        HashMap<String, Object> propuestaMap = (HashMap<String, Object>) map.get("propuesta");
        ...
        propuesta.setId(Integer.parseInt(propuestaMap.get("id").toString()));
        ps.getProyecto().setPropuesta(propuesta);
    ...
    public Response update(HashMap<String, Object> map) {
        ...
        try {
            ...
            // Asignar Inversionista y Propuesta al Proyecto desde el HashMap
            HashMap<String, Object> inversionistaMap = (HashMap<String, Object>) map.get("inversionista");
            HashMap<String, Object> propuestaMap = (HashMap<String, Object>) map.get("propuesta");
